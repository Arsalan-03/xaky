...
<body>
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">Хаку</a>
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 top-menu">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li><a class="dropdown-item" href="#">Фирменные роллы</a></li>
                                        <li><a class="dropdown-item" href="#">Запечённые роллы</a></li>
                                        <li><a class="dropdown-item" href="#">Холодные роллы</a></li>
                                        <li><a class="dropdown-item" href="#">Темпурные роллы</a></li>
                                        <li><a class="dropdown-item" href="#">Классические роллы</a></li>
                                        <li><a class="dropdown-item" href="#">Суши</a></li>
                                    </ul>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="#">Комбо Наборы</a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#">Сеты</a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link" href="#">Удон</a>
                                </li>
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="#">Дополнительное</a></li>
                                    </ul>
                                </li>
                            </ul>
